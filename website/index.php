                    ...
                    <ul>
                        ...
                        <?php } else { ?>
                            <li><a href="html/connection.php">
                                    <button type="button" class="btn btn-primary">Client area</button>
                                </a></li>
                        <?php } ?>
                    </ul>
                </div>
...
<main>
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12">
                            <div class="card text-center box" style="width: 20rem;">
                                <center><img class="size" width="300px" height="300px"
                                             src="<?php echo 'html/back_office/' . $row['image']; ?>"></center>
                                <div class="card-body">
        ...
        <center><a href="html/back_office/delete_service.php">
                <button type="button" class="btn btn-danger">Delete a service</button>
            </a></center>
        </br>
