        ...
        <section class="presentation">
            <div class="container">
                <div class="row" id="grey_box">
                    <img src="img/description.jpg" width="500px" class="costumer" class="col-lg-5 col-md-12">
                    <section id="inline">
                        <h2 id="bio">L'excellence avant tout !</h2></br>
                        <p id="description">Depuis plus de 40 ans, notre société</p>
                    </section>
                </div>
            </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="">
                    ...
                    <div class="icones" class="col-lg-4 col-sm-6 col-xs-12">
                    ...
                    <div class="icones" class="col-lg-4 col-sm-6 col-xs-12">
                        <center><img src="img/euros.png" width="190px"><br>
                            <p id="text">Des prix défiant </br>toute concurrence</p></center>
                    </div>
                    <div class="icones" class="col-lg-4 col-sm-6 col-xs-12">
